...
export const SEAT_SECTION_COLORS: Record<string, SeatColorSet> = {
  ...
  "MOTA":     { early: "bg-amber-100 dark:bg-amber-900/50",       late: "bg-amber-300 dark:bg-amber-700/70",       def: "bg-amber-200 dark:bg-amber-800/60",       border: "border-amber-400 dark:border-amber-500",     text: "text-amber-900 dark:text-amber-100" },
