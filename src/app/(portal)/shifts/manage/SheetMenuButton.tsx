...
import { importRequiredCountsFromSheetAction, regenerateShiftTableAction } from "./sufficiency-actions";
...
export default function SheetMenuButton({
  ...
  const run = (action: "import" | "required" | "regenerate") => {
    setOpen(false);
    setResult(null);
    ...
    startTransition(async () => {
      const r = action === "import"
        ...
        : await regenerateShiftTableAction(fd);
