...
最終更新：2026-05-19（v26：ページ整理・Myページ統合・ダッシュボードリンク）
...
| 管理者（project_admin / admin） | 上記スタッフ全部 ＋ 当日状況 / シフト管理 / お知らせ管理 / 問合せ管理 / 勤怠修正 / 実績出力 / 案件設定 |
| 運営者（executive） | 上記管理者全部 ＋ 案件管理 / スタッフ管理 / 運用者管理 |

- DevBanner（視点モード切替バナー）廃止
- 補正審査（/corrections/manage）は勤怠修正（/attendance/edit）のタブに統合
- Myページ：スタッフは /my、管理者・運営者は /admin/my
