...
最終更新：2026-05-18（v22：スタッフカードタップメニュー・離脱処理を全メニューに実装）
...
**Phase 3 進行中 → セクション13参照**
- ~~P3-2: スタッフカードタップ→設定・離脱処理~~ ✅ v22完了
- **P3-1: 稼働設定を仮組ロジックに反映**（次の優先タスク）
...
project_members（兼務対応）
  ...
  shift_note text,         ← ★v21新設（シフト備考。SVが入力する配慮事項）
